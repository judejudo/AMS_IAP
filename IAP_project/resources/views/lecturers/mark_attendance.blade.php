            ...
            <table>
                    ...
                    @foreach ($students as $student)
                        <tr class="p-2">
                            ...
                            <td class="p-2">
                                <a href="/mark_absent/{{ $student->id }}"><x-danger-button class="bg-fuchsia-600 w-50 h-12">Mark as Absent </x-danger-button></a> 
                            </td>
                            @else
                            <td>
                                    <a href="/mark_present/{{ $student->id }}" class="bg-fuchsia-600 w-50 h-12"><x-primary-button> Mark as Present</x-primary-button></a> 
                            </td>
                            @endif
